...
export default function TeacherCourseSwiper() {
  return (
    <>
      <Swiper pagination={true} modules={[Pagination]} className="teacher_course_swiper">
        <SwiperSlide>
        ...
        <SwiperSlide>
          <article className="rounded-xl bg-[#150f2e] p-3 shadow-lg hover:shadow-xl">
            <a href="#">
              <div className="relative flex items-end overflow-hidden rounded-xl">
                <img src="https://componentland.com/images/0WjOaKV5XYmAEPl0ZjOv4.png" alt="Hotel Photo" />
                <div className="absolute bottom-3 left-3 inline-flex items-center rounded-lg bg-white p-2 shadow-md">
